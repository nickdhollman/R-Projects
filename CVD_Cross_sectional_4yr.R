...
Demo_a <- read_xpt("filepath/DEMO_J.xpt")
CBC_a <- read_xpt("filepath/CBC_J.xpt")
HDL_a <- read_xpt("filepath/HDL_J.xpt")
TG_a <- read_xpt("filepath/TRIGLY_J.xpt")
MCQ_a <- read_xpt("filepath/MCQ_J.xpt")
ALQ_a <- read_xpt("filepath/ALQ_J.xpt")
SMQ_a <- read_xpt("filepath/SMQ_J.xpt")
BPX_a <- read_xpt("filepath/BPX_J.xpt")
TCHOL_a <- read_xpt("filepath/TCHOL_J.xpt")
BPQ_a <- read_xpt("filepath/BPQ_J.xpt")
DIQ_a <- read_xpt("filepath/DIQ_J.xpt")
BMX_a <- read_xpt("filepath/BMX_J.xpt")

#IMPORTING OTHER CYCLE OF DATA TO INCREASE POWER 
Demo_b <- read_xpt("filepath/DEMO_I.xpt")
CBC_b <- read_xpt("filepath/CBC_I.xpt")
HDL_b <- read_xpt("filepath/HDL_I.xpt")
TG_b <- read_xpt("filepath/TRIGLY_I.xpt")
MCQ_b <- read_xpt("filepath/MCQ_I.xpt")
ALQ_b <- read_xpt("filepath/ALQ_I.xpt")
SMQ_b <- read_xpt("filepath/SMQ_I.xpt")
BPX_b <- read_xpt("filepath/BPX_I.xpt")
TCHOL_b <- read_xpt("filepath/TCHOL_I.xpt")
BPQ_b <- read_xpt("filepath/BPQ_I.xpt")
DIQ_b <- read_xpt("filepath/DIQ_I.xpt")
BMX_b <- read_xpt("filepath/BMX_I.xpt")
...
write.csv(master_q, file="filepath/master_q.csv")
master_q <- read_csv("filepath/master_q.csv", show_col_types = TRUE)
